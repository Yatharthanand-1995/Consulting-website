  ...
  const resources = [
    {
      ...
      description:
        'A comprehensive guide to successfully implementing AI across large organizations, based on 500+ successful deployments.',
      type: 'whitepapers',
      category: 'Strategy',
      readTime: '45 min',
    ...
    },
    {
      ...
      description:
        'Data-driven insights from real AI implementations showing average ROI of 340% within 18 months.',
      type: 'reports',
      category: 'Analytics',
      readTime: '30 min',
      downloadCount: '8,200+',
    ...
    },
    {
      ...
      description:
        'Best practices for ethical AI deployment, including bias detection, fairness metrics, and governance structures.',
      type: 'whitepapers',
      category: 'Governance',
      readTime: '35 min',
    ...
    },
    {
      ...
      description:
        'How a Fortune 500 retailer used AI-powered demand forecasting to reduce inventory costs by $45M annually.',
      type: 'case-studies',
      category: 'Retail',
      readTime: '20 min',
      downloadCount: '6,700+',
    ...
    },
    {
      ...
      description:
        'Step-by-step methodology for implementing Large Language Models in enterprise environments.',
      type: 'guides',
    ...
    },
    {
      ...
      description:
        "Interactive assessment to evaluate your organization's readiness for AI transformation across 12 key dimensions.",
      type: 'tools',
      category: 'Assessment',
      readTime: '15 min',
    ...
    },
    {
      ...
      description:
        'Analysis of AI-powered medical diagnostics showing 97.8% accuracy rates across 50,000+ cases.',
      type: 'case-studies',
      category: 'Healthcare',
      readTime: '25 min',
      downloadCount: '4,500+',
    ...
    },
    {
      ...
      description:
        'How predictive maintenance AI reduced downtime by 70% and saved $100M annually for automotive manufacturer.',
      type: 'case-studies',
    ...
    },
    {
      ...
      description:
        'Comprehensive analysis of emerging AI trends and their business implications for the next 3 years.',
      type: 'reports',
      category: 'Trends',
      readTime: '40 min',
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-3xl text-xl leading-relaxed lg:text-2xl">
              Access our comprehensive library of research, case studies, and
              implementation guides to accelerate your AI transformation
              journey.
            </p>
          </div>
        </div>
      ...
      <section className="bg-muted/20 py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-4xl gap-8 text-center md:grid-cols-4">
            <div>
              <div className="text-secondary mb-2 text-3xl font-bold">50+</div>
              <div className="text-muted-foreground">Research Papers</div>
            </div>
            <div>
              <div className="text-secondary mb-2 text-3xl font-bold">25+</div>
            ...
            <div>
              <div className="text-secondary mb-2 text-3xl font-bold">15+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-6xl">
            <div className="mb-16 text-center">
              ...
              <p className="text-muted-foreground text-xl">
                Browse our full collection of research, insights, and practical
                tools
              </p>
            </div>
            ...
            <div className="mb-12 flex justify-center">
              <div className="bg-background border-border flex flex-wrap gap-2 rounded-lg border p-1">
            ...
            <Card variant="neural" padding="lg">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mx-auto mb-8 max-w-2xl">
                  Get the latest AI insights, research findings, and
                  implementation guides delivered directly to your inbox every
                  month.
                </p>
                ...
                <div className="mx-auto flex max-w-2xl flex-col items-center justify-center gap-4 sm:flex-row">
                  <input
                    ...
                    className="border-border bg-background focus:ring-secondary h-12 min-w-0 flex-1 rounded-lg border px-4 py-3 text-center text-base focus:ring-2 focus:outline-none sm:min-w-[300px] sm:text-left"
                  />
                  <Button
                    variant="gradient"
                    size="lg"
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-xl">
              Looking for industry-specific insights or custom analysis for your
              AI initiative? Our research team can create tailored reports for
              your organization.
            </p>
