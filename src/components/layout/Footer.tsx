...
const socialLinks = [
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/stratex-ai',
    icon: (
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/stratex_ai',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/stratex-ai',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@stratex-ai',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn('bg-card border-border border-t', className)}>
      {/* Main Footer Content */}
      <div className="container-professional section-professional">
        <div className="grid-24 gap-6">
          ...
          <div className="space-y-lg col-span-24 md:col-span-12 lg:col-span-8">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              intelligent automation. Where strategy meets intelligence for
              exceptional results.
            </p>
          ...
          {Object.entries(footerSections).map(([key, section]) => (
            <div
              key={key}
              className="space-y-md col-span-12 md:col-span-6 lg:col-span-4"
            >
              ...
              <ul className="space-y-sm">
                {section.links.map(link => (
                  <li key={link.href}>
                    <a
                      href={link.href}
                      className="text-muted-foreground hover:text-secondary text-sm transition-colors duration-200"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        {/* Newsletter Signup */}
        <div className="section-content border-border border-t">
          <div className="flex-between flex-wrap gap-6">
            <div className="space-y-sm">
              <h4 className="text-foreground font-semibold">Stay Updated</h4>
              <p className="text-muted-foreground text-sm">
                Get the latest AI insights and industry reports delivered to
                your inbox.
              </p>
            </div>
            <div className="flex-professional">
        ...
        {/* Certifications */}
        <div className="section-content border-border space-y-lg border-t">
      ...
      <div className="border-border bg-muted/30 border-t">
        <div className="container-professional section-content">
          <div className="flex-between flex-wrap gap-4">
            {/* Copyright */}
            <div className="flex-professional text-muted-foreground text-sm">
              <span>&copy; 2024 Stratex AI. All rights reserved.</span>
            </div>
              ...
              <div className="flex-professional">
                {socialLinks.map(social => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="text-muted-foreground hover:text-secondary component-button hover:bg-muted rounded-lg transition-colors"
          ...
          {/* Legal Links */}
          <div className="section-content border-border flex-center text-muted-foreground flex-wrap gap-6 border-t text-xs">
